...
describe("InscriptionDetail", () => {
    beforeEach(() => {
        ...
        mockInscriptionData = {
            ...
            "genesis_tx_id": "67fe0bc9b4f647f7d7a0da22e89342024ca0bfe06de82053453761e04084aa2f",
            "location": "67fe0bc9b4f647f7d7a0da22e89342024ca0bfe06de82053453761e04084aa2f:0:0",
    ...
    it("renders InscriptionDetail component with correct data", async () => {
        ...
        expect(screen.getByText("Inscription " + mockInscriptionData.number)).toBeInTheDocument();
        ...
        expect(screen.getByText(mockInscriptionData.value.toString())).toBeInTheDocument();
        // Encoding info, e.g. ;charset=utf-8 should be trimmed
        expect(screen.getByText("text/plain")).toBeInTheDocument();
        // Should be trimmed to 16 characters on each side
        expect(screen.getByText("67fe0bc9b4f647f7...61e04084aa2f:0:0")).toBeInTheDocument();
        expect(screen.getByText("67fe0bc9b4f647f7...453761e04084aa2f")).toBeInTheDocument();
    ...
    it("should display non-svg image content in an image element", async () => {
        ...
        await waitFor(() => {
            ...
            expect(img).toHaveAttribute("src", `https://ord.xverse.app/content/${mockInscriptionData.id}`);
        });
    });
    ...
    it("should gracefully handle unsupported content with a placeholder text", () => {
        const unsupportedData = { ...mockInscriptionData, content_type: "unsupported/type" };
