...
describe('KeyValuePair', () => {
    ...
    const value = '16b43759fc0342ca47c81c61f63b358c46caa864015cdde091c4bb1622d8964di0';
    ...
    it('truncates the value if truncate prop is true', () => {
        ...
        expect(screen.getByText('16b43759fc0342ca...c4bb1622d8964di0')).toBeInTheDocument();
    });
