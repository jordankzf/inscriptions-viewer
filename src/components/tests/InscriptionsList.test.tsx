...
describe('InscriptionsList', () => {
    ...
    it('navigates to detail page when inscription is clicked', () => {
        ...
        expect(navigate).toHaveBeenCalledWith(`/detail/${walletAddress}/${inscriptions[0].id}`);
    });
    ...
    it('trims inscription ID to 8 characters', () => {
        const longId = '1234567890123456789012345678901234567890123456789012345678901234567890';
        render(
            <InscriptionsList
        ...
        expect(screen.getByText(`Inscription ${longId.slice(0, 8)}`)).toBeInTheDocument();
    });
});